...
<body>
    ...
    <section class="" action=>
        <div class="text-container">
            ...
            <p>Calculate all about healty life</p>
        </div>
    ...
    <div class="container">
    	<div class="panel">
    		<h2 class="text-center">BMI</h2>
    		
    			<p id="introText" class="text-center">Enter weight and height below to check your BMI results</p>
    			
    			<form class="measure">
    				<div id="weightInput">
    					<p>Put your weight in here (KG)</p>
    		     		<input id="weight" type="number" pattern="[0-9]*" name="a" class="input"/>
    				</div>
    				<div id="heightInput">
    					<p>And your height in here (CM)</p>
	    				 <input id="height" type="number" pattern="[0-9]*" name="b" class="input"/> 
    				</div>
    		     <button type="button" class="button1" onclick="calculate()">Calculate BMI</button>
    		</form>
