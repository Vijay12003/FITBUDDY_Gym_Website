...
<!--content-->
    ...
    <div class="pushups">
        ...
        <video controls muted src="../video/Push Ups F.mp4" width="30%"></video>
        <ol class="tips">
    ...
    <div class="benchpress">
        ...
        <video controls muted src="../video/Bench Press F.mp4" width="30%"></video>
        <ol class="tips">
    ...
    <div class="incline">
        ...
        <hr>
        <h5>Difficulty: Intermediate</h5>
        <video controls muted src="../video/Incline Dumbell Press F.mp4" width="30%"></video>
        <ol class="tips">
            <li>Lay flat on the incline bench with your feet on the ground. Raise the dumbbells until you have straight arms.</li>
    ...
    <div class="incline">
        <h2>Incline Squeeze Press</h2>
        <hr>
        <h5>Difficulty: Intermediate</h5>
        <video controls muted src="../video/Incline Squeeze Press F.mp4" width="30%"></video>
        <ol class="tips">
            <li>Lay flat on the incline bench with your feet on the ground. Raise the dumbbells until you have straight arms.</li>
            <li>Lower the dumbbells to your mid chest</li>
            <li>Raise the dumbbells until you've locked your elbows.</li>
