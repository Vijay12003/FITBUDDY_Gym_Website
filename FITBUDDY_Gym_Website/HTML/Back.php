...
<!--Content-->
    ...
    <div class="Dumbbellrows">
        ...
        <hr>
        <h5>Difficulty: Intermediate</h5>
        <video controls muted src="..\video\Dumbbell rows.mp4" width="30%"></video>
        <ol class="tips">
    ...
    <div class="InclineRows">
        <h2>Incline Dumbbell Rows</h2>
        <hr>
        <h5>Difficulty: Intermediate</h5>
        <video controls muted src="..\video\Incline dumbbell rows.mp4" width="30%"></video>
        <ol class="tips">
