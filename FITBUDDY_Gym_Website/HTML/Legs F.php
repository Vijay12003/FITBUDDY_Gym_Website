...
<!--content-->
    ...
    <div class="Splitsquat">
        ...
        <video controls muted src="../video/Split Squats F.mp4" width="30%"></video>
        <ol class="tips">
    ...
    <div class="Legpress">
        ...
        <hr>
        <h5>Difficulty: Intermediate</h5>
        <video controls muted src="../video/Leg Press F.mp4" width="30%"></video>
        <ol class="tips">
    ...
    <div class="Calfraises">
        ...
        <hr>
        <h5>Difficulty: Intermediate</h5>
        <video controls muted src="../video/Hip Adduction F.mp4" width="30%"></video>
        <ol class="tips">
