...
<!--content-->
    ...
    <div class="Pullup">
        ...
        <video controls muted src="../video/Rope Pulldown F.mp4" width="30%"></video>
        <ol class="tips">
    ...
    <div class="Barbellrows">
        ...
        <video controls muted src="../video/Lat Pulldown F.mp4" width="30%"></video>
        <ol class="tips">
    ...
    <div class="Dumbbellrows">
        <h2>Dumbell Rows</h2>
        <hr>
        <h5>Difficulty: Intermediate</h5>
        <video controls muted src="../video/Bent Over Rows F.mp4" width="30%"></video>
        <ol class="tips">
    ...
    <div class="InclineRows">
        <h2>Cable Rows</h2>
        <hr>
        <h5>Difficulty: Intermediate</h5>
        <video controls muted src="../video/Cable Rows F.mp4" width="30%"></video>
        <ol class="tips">
            <li>Grab a barbell with a shoulder width pronated or supinated grip.</li>
            <li>Bend forward at your hips while maintaining a flat back.</li>
            <li>Pull the weight toward your upper abdomen.</li>
            <li>Lower the weight in a controlled manner and repeat.</li>
            <li>Repeat.</li>
        </ol>
    </div>
    </div>
