...
<!--Content-->
    ...
    <div class="Biceps">
        ...
        <video controls muted src="..\video\Biceps curl.mp4" width="30%"></video>
        <ol class="tips">
    ...
    <div class="Forearm">
        ...
        <video controls muted src="..\video\Forearm.mp4" width="30%"></video>
        <ol class="tips">
            <li>Grip the dumbbell with your palm facing upwards with your forearm rested against the bench.</li>
            <li>Slowly curl your wrist upwards in a semicircular motion.</li>
    ...
    <div class="Bendover">
        <h2>Bentover Biceps Curl</h2>
        <hr>
        <h5>Difficulty: Intermediate</h5>
        <video controls muted src="..\video\Bendover curl.mp4" width="30%"></video>
        <ol class="tips">
            <li>Sit down straight with a dumbbell in each hand at arm's length.</li>
    ...
    <div class="Triceps">
        ...
        <hr>
        <h5>Difficulty: Intermediate</h5>
        <video controls muted src="..\video\Triceps extension.mp4" width="30%"></video>
        <ol class="tips">
