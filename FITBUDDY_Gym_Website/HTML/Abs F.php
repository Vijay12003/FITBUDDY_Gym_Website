...
<!--content-->
    ...
    <div class="Legraises">
        ...
        <video controls muted src="../video/Rushian Twists F.mp4" width="30%"></video>
        <ol class="tips">
    ...
    <div class="Crunches">
        ...
        <video controls muted src="../video/Crunches F.mp4" width="30%"></video>
        <ol class="tips">
    ...
    <div class="Superman">
        ...
        <hr>
        <h5>Difficulty: Intermediate</h5>
        <video controls muted src="../video/Reverse Crunches F.mp4" width="30%"></video>
        <ol class="tips">
